...
def main():
    ...
    all_imp = run_all_species(dff, env, max_depth=5)
    ...
    draw_heatmap(M_red, species, glossary,
                 ...
                 f"(DT Gini importance; variables with max importance > {args.threshold} or top-{args.top_n} in any species)",
                 FIGDIR / "figure2_reduced.png", fontsize=8)
    draw_heatmap(M, species, glossary,
                 "Figure S12. Full feature-importance heatmap (all variables)",
                 FIGDIR / "figureS12_full.png", fontsize=5)
